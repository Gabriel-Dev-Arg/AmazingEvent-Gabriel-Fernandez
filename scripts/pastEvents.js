...
let pastEventsContainer = document.getElementById("past-events-container");
            ...
            tarjeta.innerHTML = `
                <div class="card m-1 width_18rem ">
                    ...
                    <div class="card-body">
                        ...
                        </p><a href="./Details.html?id=${event._id}" class="btn btn-primary">Details</a></div>
                    </div>
                </div>
            `;
            pastEventsContainer.appendChild(tarjeta);
        });
    }
}
